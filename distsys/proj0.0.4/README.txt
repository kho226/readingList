...
Building: 
    ```
        go build distsys/proj0.0.4/frontend/web/main.go
        go build distsys/proj0.0.4/backend/main.go
    ```
Testing:
    ```
        go test distsys/proj0.0.4/frontend/services
        go test distsys/proj0.0.4/frontend/utils

        go test distsys/proj0.0.4/backend/services
        go test distsys/proj0.0.4/backend/utils
    ```
Running:
    ```
        cd distsys/proj0.0.4/backend
...
- in one terminal window (Client 1)
	```
		cd distsys/proj0.0.4/frontend/web
